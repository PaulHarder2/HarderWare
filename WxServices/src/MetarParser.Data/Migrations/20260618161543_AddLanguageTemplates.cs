    ...
    public partial class AddLanguageTemplates : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(table: "LanguageTemplates", columns: cols, values: new object[,]
            {
                ...
                { 37L, "GridTimeLegend", "Times use a 24-hour clock: 00 = midnight, 12 = noon, 24 = midnight.", "Legend beneath the forecast grid explaining its 24-hour clock columns (WX-190).", "Hint", true },
                ...
                { 37L, "CondSevereStorms", "Severe storms", "Forecast lead noun for severe convective storms (hazard banner / change band).", "Hint", true },
                { 37L, "CondSevereWeather", "Severe weather", "Forecast lead noun for severe non-convective weather, e.g. damaging wind with no precip.", "Hint", true },
                { 37L, "ChangeTempNoun", "Temperature change", "Change-band noun for a temperature change.", "Hint", true },
                { 37L, "ChangeWindNoun", "Wind change", "Change-band noun for a wind change.", "Hint", true },
                { 37L, "DirAppearing", "developing", "Change-band direction gerund: a phenomenon developing/appearing.", "Hint", true },
                { 37L, "DirStrengthening", "intensifying", "Change-band direction gerund: a phenomenon intensifying.", "Hint", true },
                { 37L, "DirWeakening", "easing", "Change-band direction gerund: a phenomenon easing/weakening.", "Hint", true },
