...
public sealed class ClaudeClient
{
    ...
    /// API with the same retry/backoff policy as
    /// <see cref="GenerateReportAsync"/>, and returns the raw tool_use input
    /// JSON plus token-usage metadata.  Returns <see langword="null"/> on
