...
public class GfsSnapshotBuilderTests
{
    ...
    {
        var body = GfsSnapshotBuilder.Build(new GfsHourlyForecast { ModelRunUtc = BlockStart, Hours = [] });
    ...
    public void Build_BlockWithFewerThanFourHours_IsSkipped()
    {
        ...
        var body = GfsSnapshotBuilder.Build(Forecast(Hour(0), Hour(1), Hour(2)));
        Assert.Empty(body.Blocks);
    }
    ...
    public void Build_BlockWithFourHoursOfPresentData_IsEmitted()
    {
        ...
        var body = GfsSnapshotBuilder.Build(Forecast(Hour(0), Hour(1), Hour(2), Hour(3)));
        Assert.Single(body.Blocks);
    }
    ...
    public void Build_RespectsMaxBlocksCap()
    {
        ...
        var body = GfsSnapshotBuilder.Build(Forecast(hours));
    ...
    public void Build_IsDeterministic_IdenticalInputsProduceByteIdenticalSerialisation()
    {
        ...
        var first = GfsSnapshotBuilder.Build(inputs()).Serialize();
        var second = GfsSnapshotBuilder.Build(inputs()).Serialize();
